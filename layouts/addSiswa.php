...
if (isset($_POST['submit'])) {
    ...
    if ($sql) {
        ...
        $update = $conn->query("UPDATE siswa SET token='$hsl' WHERE nisn = '$nisn'");
        if ($update) {
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="form-row">
                            <div class="form-group col-md-3">
                                ...
                                <input type="number" name="bindo" class="form-control" placeholder="...">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Nilai MTK</label>
                                <input type="number" name="mtk" class="form-control" placeholder="...">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Nilai IPA</label>
                                <input type="number" name="ipa" class="form-control" placeholder="...">
                            </div>
                            <div class="form-group col-md-3">
                                <label>Nilai IPS</label>
                                <input type="number" name="ips" class="form-control" placeholder="...">
                            </div>
                        </div>
                        <div class="form-group">
